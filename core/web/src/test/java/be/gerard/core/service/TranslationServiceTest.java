...
import be.gerard.core.translation.interface_v1.TranslationService;
...
public class TranslationServiceTest extends BaseTest {
    ...
    public void crudTest() {
        Translation translation = new Translation(application, language, key, value);
        translationService.save(translation);

        Translation translation1 = translationService.find(application, Language.NL, key);
