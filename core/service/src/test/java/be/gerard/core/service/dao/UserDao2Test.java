 ...
 * @version 0.0.1
 */
public class UserDao2Test extends BaseTest {
    ...
    public void test() {
        ...
        UserRecord userRecordAfterFindOne = userDao.findOne(userRecord.getId());
        ...
        Assert.assertNull("userDao did not delete record", userDao.findOne(userRecord.getId()));
